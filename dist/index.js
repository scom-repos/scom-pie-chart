...
define("@scom/scom-pie-chart", ["require", "exports", "@ijstech/components", "@scom/scom-charts", "@scom/scom-pie-chart/global/index.ts", "@scom/scom-pie-chart/index.css.ts", "@scom/scom-pie-chart/assets.ts", "@scom/scom-pie-chart/data.json.ts", "@scom/scom-chart-data-source-setup", "@scom/scom-pie-chart/formSchema.ts", "@scom/scom-pie-chart/dataOptionsForm.tsx", "@scom/scom-pie-chart/dts/index.ts"], function (require, exports, components_5, scom_charts_1, index_1, index_css_1, assets_1, data_json_1, scom_chart_data_source_setup_1, formSchema_1, dataOptionsForm_1, index_2) {
    ...
    let ScomPieChart = class ScomPieChart extends components_5.Module {
        ...
        renderChart() {
            ...
            const pieChart = new scom_charts_1.ScomCharts(this.pnlPieChart, {
                data: _chartData,
                width: '100%',
                height: '100%'
            });
        ...
        resize() {
            if (this.pnlPieChart) {
                this.pnlPieChart.firstChild?.resize();
            }
        }
        async init() {
            this.updateTheme();
